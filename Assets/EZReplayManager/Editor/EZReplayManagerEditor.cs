...
public class EZReplayManagerEditor : PropertyEditor {
    ...
    private SerializedProperty recordingBufferSecondsProperty;
	...
	protected override void Initialize ()
	{
        ...
        recordingBufferSecondsProperty = serializedObject.FindProperty("recordingBufferSeconds");
	...
	public override void OnInspectorGUI ()
	{
		...
		BeginEdit ();
			...
			BeginSection ("Options and Features");
				...
				PropertyField ("Seconds to buffer", recordingBufferSecondsProperty);
				if (EZReplayManager.get.showHintsForImportantOptions)
					Comment ("Seconds to buffer:\r\n\r\nThis is the amount of seconds that are being saved/buffered. All frames falling out of this range will be deleted. A value of 0 will result in no frames being purged, thus all saved.\r\n\r\nDefault: 5");	
