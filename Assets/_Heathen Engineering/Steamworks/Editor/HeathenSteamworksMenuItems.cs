...
namespace HeathenEngineering.SteamTools
{
    public class HeathenSteamworksMenuItems
    {
        ...
        [MenuItem("Help/Steamworks/Heathen's Steamworks Documentation")]
        [MenuItem("Steamworks/Help/Heathen's Steamworks Documentation")]
        public static void HeathenSteamworksDocumentation()
        {
            Application.OpenURL("https://heathen.zendesk.com/hc/en-us/sections/360004996954-Steamworks");
        }
