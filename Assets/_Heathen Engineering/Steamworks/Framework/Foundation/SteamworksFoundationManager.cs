...
{
    /// <summary>
    /// A variant of SteamManager as provided by Steamworks.net
    /// The primary difference is configuraiton settings exposed to the editor and integrated with Heathen System Core
    /// </summary>
        ...
        private void Awake()
        {
            ...
            else
            {
             ...
             //   Photon.Pun.PhotonNetwork.AutomaticallySyncScene = true;
              //  Photon.Pun.PhotonNetwork.AuthValues.UserId = SteamUser.GetSteamID().ToString();
