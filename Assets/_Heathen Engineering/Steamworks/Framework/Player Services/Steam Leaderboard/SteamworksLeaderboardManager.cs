...
namespace HeathenEngineering.SteamTools
{
    ...
    {
        public List<HeathenSteamLeaderboardData> Leaderboards;
        ...
        public HeathenSteamLeaderboardData GetLeaderboard(string name)
        {
        ...
        /// <returns>Returns the leaderboard found if any else returns null</returns>
        public HeathenSteamLeaderboardData GetLeaderboard(LeaderboardRankChangeData chageData)
        {
        ...
        /// <param name="score">The score to upload</param>
        /// <param name="method">The upload method</param>
        public void UploadLeaderboardScore(HeathenSteamLeaderboardData leaderboard, int score, ELeaderboardUploadScoreMethod method)
        {
        ...
        /// <param name="score">The score to upload</param>
        /// <param name="method">The upload method</param>
        public static void _UploadLeaderboardScore(HeathenSteamLeaderboardData leaderboard, int score, ELeaderboardUploadScoreMethod method)
        {
            if (Instance == null)
                return;
