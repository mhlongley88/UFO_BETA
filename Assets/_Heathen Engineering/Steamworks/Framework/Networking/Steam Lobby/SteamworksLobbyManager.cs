    ...
    public class SteamworksLobbyManager : HeathenBehaviour, ISteamworksLobbyManager
    {
        ...
        private void Start()
        {
            if (LobbySettings == null)
            {
                ...
                LobbySettings = ScriptableObject.CreateInstance<HeathenSteamLobbySettings>();
                LobbySettings.MaxMemberCount = new Scriptable.IntReference(250);
                LobbySettings.Members = new List<LobbyMember>();
                LobbySettings.Metadata = new LobbyMetadata();
            }
            ...
            {
                Debug.LogWarning("Lobby settings Max Member Count (" + LobbySettings.MaxMemberCount.ToString() + ") is out of bounds, Min = 0, Max = 250, the value will be clamped to the valid range.");
            }
        ...
        private void OnEnable()
        {
            ...
            Debug.Log("Lobby settings registered with Max Member Count = " + LobbySettings.MaxMemberCount.ToString() + ".");
