...
namespace HeathenEngineering.SteamTools
{
    public class HeathenWorkshopBrowser : MonoBehaviour
    {
        ...
        private void Awake()
        {
            workshopSystem.RegisterWorkshopSystem();
        }
        ...
        public void SearchAll(string filter)
        {
            ...
            {
                workshopSystem.WorkshopSetSearchText(ActiveQuery.handle, filter);
            }
        ...
        public void SetNextSearchPage()
        {
            if (ActiveQuery != null)
            {
                ...
                if (!string.IsNullOrEmpty(lastSearchString))
                    workshopSystem.WorkshopSetSearchText(ActiveQuery.handle, lastSearchString);
