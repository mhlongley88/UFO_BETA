...
namespace HeathenEngineering.SteamTools
{
    ...
    public class HeathenWorkshopReadCommunityItem
    {
        ...
        public HeathenWorkshopReadCommunityItem(SteamUGCDetails_t itemDetails)
        {
            ...
            CreatedOn = HelperTools.ConvertNixDate(itemDetails.m_rtimeCreated);
            LastUpdated = HelperTools.ConvertNixDate(itemDetails.m_rtimeUpdated);
            ...
            IsSubscribed = HelperTools.WorkshopItemStateHasFlag(StateFlags, EItemState.k_EItemStateSubscribed);
